...
chrome.tabs.onUpdated.addListener(function(tabId, changeInfo, tab) {
  ...
  chrome.tabs.executeScript(
    ...
    {
      code:
        "var injected = window.octotreeInjected; window.octotreeInjected = true; injected;",
    ...
    function(res) {
      ...
      var cssFiles = ["file-icons.css", "octotree.css"];
